...
app.get('/api/predict', (req, res) => {
    ...
    // Generate sample data and run AI engine
    const records = generateSampleData(100);
...
app.get('/api/health', (req, res) => {
    res.json({ status: "online", timestamp: new Date().toISOString(), version: "TRIDENT V23" });
});
...
// ============================================
app.listen(PORT, () => {
    console.log(`🚀 TRIDENT V23 Server running on http://localhost:${PORT}`);
