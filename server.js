...
app.get('/api/verify-key', verifyLimiter, (req, res) => {
    ...
    console.log(`Key verification: ${isValid ? '✅ SUCCESS' : '❌ FAILED'}`);
...
app.get('/api/predict', async (req, res) => {
    ...
    // CORRECT: Latest period + 1 = Current period
    let nextPeriod = "------";
    try {
    ...
    console.log(`✅ Prediction: ${result.prediction} (${fmt(result.confidence)})`);
    res.json(response);
});
